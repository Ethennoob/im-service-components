...
interface UserGroupMemberServiceInterface
{
     ...
     * @return mixed
     */
    public function getAllUserMember($userId);

    /**
     * 快速添加好友
     * @param $currentUserGroupId
     * @param $currentUid
     * @param $friendUserGroupId
     * @param $friendUid
     * @return mixed
     */
    public function newQuickFriends($currentUserGroupId ,$currentUid, $friendUserGroupId, $friendUid);
     ...
     * @return mixed
     */
    public function getGroupUserMemberByCondition($where, $single = true);
